...
function buildSrcdoc(
  ...
  return `<!DOCTYPE html>
<html><head><style>
  html, body { margin: 16px; padding: 0; overflow: auto; display: flex; align-items: flex-start; justify-content: center; width: calc(100% - 32px); min-height: calc(100% - 32px); background: white; }
      ...
      <div className="shrink-0 flex items-center justify-between px-4 h-10">
        <div className="flex items-center gap-1 text-xs text-muted-foreground">
          <button
            ...
            className="p-1.5 rounded-md hover:bg-accent hover:text-foreground disabled:opacity-30 cursor-pointer"
            title="Zoom out"
          >
          ...
          <button
            onClick={zoomReset}
            className="tabular-nums hover:text-foreground cursor-pointer min-w-[3.5ch] text-center"
            title="Reset zoom"
          >
          ...
          <button
            onClick={() => downloadContent(content, type)}
            className="p-1.5 rounded-md hover:bg-accent hover:text-foreground cursor-pointer"
            title="Download"
          >
