...
export const listUsers = () => apiFetch<AdminUser[]>("/v1/admin/users");
...
export const deleteAnyKB = (kbId: string) =>
  apiFetch<void>(`/v1/superadmin/knowledge-bases/${kbId}`, {
    method: "DELETE",
  });
...
export const getGlobalStats = () => apiFetch<GlobalStats>("/v1/admin/stats");
...
export const listLatexTemplates = () =>
  apiFetch<LatexTemplate[]>("/v1/superadmin/latex-templates");

export const getKBLatexTemplate = (kbId: string) =>
  apiFetch<LatexTemplate | null>(`/v1/superadmin/wikis/${kbId}/latex-template`);

export const assignKBLatexTemplate = (
  kbId: string,
  templateId: string | null,
) =>
  apiFetch<LatexTemplate | null>(
    `/v1/superadmin/wikis/${kbId}/latex-template`,
    {
      method: "PUT",
